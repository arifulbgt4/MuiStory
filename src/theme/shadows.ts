...
const TRANSPARENT_ONE: string = alpha(COLOR, 0.2);
const TRANSPARENT_TWO: string = alpha(COLOR, 0.14);
const TRANSPARENT_THREE: string = alpha(COLOR, 0.12);

const shadows: ShadowsOptions = [
  `none`,
